...
/**
 * Application service for administrative operations.
 * Handles schedule creation, doctor directory listing, and doctor permission updates.
 */
@Service
public class AdminService {

    /**
     * Creates a new doctor schedule entry and returns a generated schedule ID.
     */
    ...
    /**
     * Returns the list of registered doctors with their IDs, names, departments, and roles.
     */
    ...
    /**
     * Updates the permissions for the specified doctor.
     */
